          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-2 text-sm text-slate-500">
              {summary
                ...
                : `${totalExtraCredits} creditos extras para campanhas pontuais.`}
            </p>
          </div>
    ...
    >
      <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
        ...
        >
          ...
          <p className="mt-1 text-xs text-slate-500">Sem recorrencia e sem impacto no plano atual</p>
        </div>
      </div>
      ...
      <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div className="rounded-[1.5rem] border border-slate-200 bg-[linear-gradient(180deg,#ffffff_0%,#f8fafc_100%)] p-5">
          ...
          <p className="mt-1 text-xs uppercase tracking-[0.18em] text-slate-400">Creditos extras</p>
        </div>
      ...
      {summary && (
        <div className="mt-5 rounded-[1.5rem] border border-dashed border-slate-300 bg-white p-4 text-sm text-slate-600">
          <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
            <div>
              <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-400">Saldo extra atual</p>
      ...
      <div className="mt-6 flex flex-col gap-4 rounded-[1.5rem] border border-slate-200 bg-slate-50/80 p-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="mt-2 text-sm leading-relaxed text-slate-600">
            O sistema consome primeiro os creditos do plano e depois usa os creditos extras do booster.
          </p>
        </div>
        <button
          onClick={onPurchase}
