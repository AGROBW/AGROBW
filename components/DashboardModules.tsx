...
export const DashboardStatsCard: React.FC<StatsCardProps> = ({
  icon,
  label,
  value,
  bgColor,
  ...
  if (loading) {
    return (
      <div className="animate-pulse rounded-[24px] border border-slate-200/80 bg-[linear-gradient(180deg,#ffffff_0%,#f8fafc_100%)] p-5 xl:p-6 shadow-[0_18px_45px_-36px_rgba(15,23,42,0.4)]">
        <div className="flex items-center justify-between">
          <div className="space-y-2">
            <div className="h-3 w-24 bg-slate-100 rounded" />
            <div className="h-6 w-16 bg-slate-100 rounded" />
          </div>
          <div className={`h-11 w-11 rounded-lg xl:h-12 xl:w-12 ${bgColor}`} />
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="rounded-[24px] border border-slate-200/80 bg-[linear-gradient(180deg,#ffffff_0%,#f8fafc_100%)] p-5 xl:p-6 shadow-[0_18px_45px_-36px_rgba(15,23,42,0.4)] transition-all hover:-translate-y-0.5 hover:shadow-[0_24px_55px_-36px_rgba(15,23,42,0.5)]">
      <div className="flex items-center justify-between">
        <div>
          <p className="mb-1 text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500 xl:text-xs xl:tracking-[0.2em]">{label}</p>
          <p className="text-[28px] font-bold leading-none text-slate-900 xl:text-3xl">{value}</p>
        </div>
        <div className={`flex h-11 w-11 items-center justify-center rounded-2xl shadow-sm xl:h-12 xl:w-12 ${bgColor} ${iconColor}`}>
          {icon}
        </div>
      </div>
    </div>
...
// ============================================
// 2. REACH MODULE (Mapa + Top 5 Estados)
// ============================================

interface ReachModuleProps {
  clicksByState: StateClicks[];
  loading?: boolean;
}

export const ReachModule: React.FC<ReachModuleProps> = ({ clicksByState, loading = false }) => {
  const maxClicks = clicksByState.length > 0 ? clicksByState[0].clicks : 1;
    ...
    <div className="rounded-[26px] border border-slate-200/80 bg-[linear-gradient(180deg,#ffffff_0%,#f8fafc_100%)] p-5 xl:p-6 shadow-[0_24px_55px_-40px_rgba(15,23,42,0.42)]">
      ...
      {clicksByState.length === 0 ? (
        <div className="py-7 text-center text-slate-500 xl:py-8">
          ...
          <p className="text-[13px] xl:text-sm">Nenhum clique registrado ainda</p>
        </div>
      ) : (
        <div className="grid grid-cols-1 gap-5 xl:grid-cols-2 xl:gap-6">
          {/* Lista de Estados com Scroll */}
          <div className="max-h-[340px] space-y-2.5 overflow-y-auto pr-2 xl:max-h-[400px] xl:space-y-3" style={{ scrollbarWidth: 'thin', scrollbarColor: '#cbd5e1 #f1f5f9' }}>
            {clicksByState.map((item, index) => {
              const percentage = (item.clicks / maxClicks) * 100;
              return (
                <div key={item.state} className="space-y-1">
                  <div className="flex items-center justify-between text-[13px] xl:text-sm">
                    <span className="font-semibold text-slate-700">
                      #{index + 1} {item.state}
                    </span>
                    <span className="text-slate-600">{item.clicks} cliques</span>
                  </div>
          ...
          <div className="relative h-[340px] overflow-hidden rounded-[22px] border border-slate-200 bg-gradient-to-br from-slate-50 to-blue-50 shadow-inner xl:h-[400px]">
            <svg 
              viewBox="0 0 450 460" 
              className="h-full w-full p-3 xl:p-4"
            ...
            >
              ...
              <path 
                ...
                fill={clicksByState.find(s => s.state === 'TO') ? '#059669' : '#e2e8f0'}
                filter={clicksByState.find(s => s.state === 'TO') ? 'url(#glow)' : ''}
              ...
              <path 
                ...
                fill={clicksByState.find(s => s.state === 'BA') ? '#059669' : '#e2e8f0'}
                filter={clicksByState.find(s => s.state === 'BA') ? 'url(#glow)' : ''}
                className="transition-all duration-300 hover:fill-green-700 cursor-pointer"
              />
              ...
              <path 
                ...
                fill={clicksByState.find(s => s.state === 'SE') ? '#059669' : '#e2e8f0'}
                filter={clicksByState.find(s => s.state === 'SE') ? 'url(#glow)' : ''}
                className="transition-all duration-300 hover:fill-green-700 cursor-pointer"
              />
              ...
              <path 
                ...
                fill={clicksByState.find(s => s.state === 'PE') ? '#059669' : '#e2e8f0'}
                filter={clicksByState.find(s => s.state === 'PE') ? 'url(#glow)' : ''}
                className="transition-all duration-300 hover:fill-green-700 cursor-pointer"
              />
              ...
              <path 
                ...
                fill={clicksByState.find(s => s.state === 'AL') ? '#059669' : '#e2e8f0'}
                filter={clicksByState.find(s => s.state === 'AL') ? 'url(#glow)' : ''}
                className="transition-all duration-300 hover:fill-green-700 cursor-pointer"
              />
              ...
              <path 
                ...
                fill={clicksByState.find(s => s.state === 'RN') ? '#059669' : '#e2e8f0'}
                filter={clicksByState.find(s => s.state === 'RN') ? 'url(#glow)' : ''}
                className="transition-all duration-300 hover:fill-green-700 cursor-pointer"
              />
              ...
              <path 
                ...
                fill={clicksByState.find(s => s.state === 'CE') ? '#059669' : '#e2e8f0'}
                filter={clicksByState.find(s => s.state === 'CE') ? 'url(#glow)' : ''}
                className="transition-all duration-300 hover:fill-green-700 cursor-pointer"
              />
              ...
              <path 
                ...
                fill={clicksByState.find(s => s.state === 'PI') ? '#059669' : '#e2e8f0'}
                filter={clicksByState.find(s => s.state === 'PI') ? 'url(#glow)' : ''}
                className="transition-all duration-300 hover:fill-green-700 cursor-pointer"
              />
              ...
              <path 
                ...
                fill={clicksByState.find(s => s.state === 'MA') ? '#059669' : '#e2e8f0'}
                filter={clicksByState.find(s => s.state === 'MA') ? 'url(#glow)' : ''}
                className="transition-all duration-300 hover:fill-green-700 cursor-pointer"
              />
              ...
              <path 
                ...
                fill={clicksByState.find(s => s.state === 'AP') ? '#059669' : '#e2e8f0'}
                filter={clicksByState.find(s => s.state === 'AP') ? 'url(#glow)' : ''}
                className="transition-all duration-300 hover:fill-green-700 cursor-pointer"
              />
              ...
              <path 
                ...
                fill={clicksByState.find(s => s.state === 'PA') ? '#059669' : '#e2e8f0'}
                filter={clicksByState.find(s => s.state === 'PA') ? 'url(#glow)' : ''}
                className="transition-all duration-300 hover:fill-green-700 cursor-pointer"
              />
              ...
              <path 
                ...
                fill={clicksByState.find(s => s.state === 'RR') ? '#059669' : '#e2e8f0'}
                filter={clicksByState.find(s => s.state === 'RR') ? 'url(#glow)' : ''}
                className="transition-all duration-300 hover:fill-green-700 cursor-pointer"
              />
              ...
              <path 
                ...
                fill={clicksByState.find(s => s.state === 'AM') ? '#059669' : '#e2e8f0'}
                filter={clicksByState.find(s => s.state === 'AM') ? 'url(#glow)' : ''}
                className="transition-all duration-300 hover:fill-green-700 cursor-pointer"
              />
              ...
              <path 
                ...
                fill={clicksByState.find(s => s.state === 'AC') ? '#059669' : '#e2e8f0'}
                filter={clicksByState.find(s => s.state === 'AC') ? 'url(#glow)' : ''}
                className="transition-all duration-300 hover:fill-green-700 cursor-pointer"
              />
              ...
              <path 
                ...
                fill={clicksByState.find(s => s.state === 'RO') ? '#059669' : '#e2e8f0'}
                filter={clicksByState.find(s => s.state === 'RO') ? 'url(#glow)' : ''}
                className="transition-all duration-300 hover:fill-green-700 cursor-pointer"
              />
              ...
              <path 
                ...
                fill={clicksByState.find(s => s.state === 'MT') ? '#059669' : '#e2e8f0'}
                filter={clicksByState.find(s => s.state === 'MT') ? 'url(#glow)' : ''}
                className="transition-all duration-300 hover:fill-green-700 cursor-pointer"
              />
              ...
              <path 
                ...
                fill={clicksByState.find(s => s.state === 'MS') ? '#059669' : '#e2e8f0'}
                filter={clicksByState.find(s => s.state === 'MS') ? 'url(#glow)' : ''}
                className="transition-all duration-300 hover:fill-green-700 cursor-pointer"
              />
              ...
              <path 
                ...
                fill={clicksByState.find(s => s.state === 'GO') ? '#059669' : '#e2e8f0'}
                filter={clicksByState.find(s => s.state === 'GO') ? 'url(#glow)' : ''}
                className="transition-all duration-300 hover:fill-green-700 cursor-pointer"
              />
              ...
              <path 
                ...
                fill={clicksByState.find(s => s.state === 'DF') ? '#059669' : '#e2e8f0'}
                filter={clicksByState.find(s => s.state === 'DF') ? 'url(#glow)' : ''}
                className="transition-all duration-300 hover:fill-green-700 cursor-pointer"
              />
              ...
              <path 
                ...
                fill={clicksByState.find(s => s.state === 'PB') ? '#059669' : '#e2e8f0'}
                filter={clicksByState.find(s => s.state === 'PB') ? 'url(#glow)' : ''}
                className="transition-all duration-300 hover:fill-green-700 cursor-pointer"
              />
              ...
              <path 
                ...
                fill={clicksByState.find(s => s.state === 'PR') ? '#059669' : '#e2e8f0'}
                filter={clicksByState.find(s => s.state === 'PR') ? 'url(#glow)' : ''}
                className="transition-all duration-300 hover:fill-green-700 cursor-pointer"
              />
              ...
              <path 
                ...
                fill={clicksByState.find(s => s.state === 'SC') ? '#059669' : '#e2e8f0'}
                filter={clicksByState.find(s => s.state === 'SC') ? 'url(#glow)' : ''}
                className="transition-all duration-300 hover:fill-green-700 cursor-pointer"
              />
              ...
              <path 
                ...
                fill={clicksByState.find(s => s.state === 'RS') ? '#059669' : '#e2e8f0'}
                filter={clicksByState.find(s => s.state === 'RS') ? 'url(#glow)' : ''}
                className="transition-all duration-300 hover:fill-green-700 cursor-pointer"
              />
              ...
              <path 
                ...
                fill={clicksByState.find(s => s.state === 'SP') ? '#059669' : '#e2e8f0'}
                filter={clicksByState.find(s => s.state === 'SP') ? 'url(#glow)' : ''}
                className="transition-all duration-300 hover:fill-green-700 cursor-pointer"
              />
              ...
              <path 
                ...
                fill={clicksByState.find(s => s.state === 'MG') ? '#059669' : '#e2e8f0'}
                filter={clicksByState.find(s => s.state === 'MG') ? 'url(#glow)' : ''}
                className="transition-all duration-300 hover:fill-green-700 cursor-pointer"
              />
              ...
              <path 
                ...
                fill={clicksByState.find(s => s.state === 'ES') ? '#059669' : '#e2e8f0'}
                filter={clicksByState.find(s => s.state === 'ES') ? 'url(#glow)' : ''}
                className="transition-all duration-300 hover:fill-green-700 cursor-pointer"
              />
              ...
              <path 
                ...
                fill={clicksByState.find(s => s.state === 'RJ') ? '#059669' : '#e2e8f0'}
                filter={clicksByState.find(s => s.state === 'RJ') ? 'url(#glow)' : ''}
                className="transition-all duration-300 hover:fill-green-700 cursor-pointer"
              />
            </svg>

            {/* Legenda */}
            <div className="absolute bottom-3 left-3 bg-white/95 backdrop-blur-sm rounded-lg px-3 py-2 shadow-md border border-slate-200">
              <div className="flex items-center gap-2 text-xs">
                <div className="w-3 h-3 bg-green-600 rounded" />
                <span className="font-medium text-slate-700">Com cliques</span>
              </div>
            </div>

            {/* Contador de UFs */}
            <div className="absolute top-3 right-3 flex h-9 w-9 items-center justify-center rounded-full bg-green-600 text-white shadow-lg xl:h-10 xl:w-10">
              <div className="text-center">
                <div className="text-base font-bold xl:text-lg">{clicksByState.length}</div>
                <div className="text-[6px] uppercase font-semibold xl:text-[7px]">UFs</div>
              </div>
            </div>
          </div>
        </div>
...
interface PriceIntelligenceModuleProps {
  ...
  onAdChange?: (adId: string | null) => void;
}

export const PriceIntelligenceModule: React.FC<PriceIntelligenceModuleProps> = ({
  priceAnalysis,
  loading = false,
  ads = [],
  selectedAdId = null,
  ...
  if (loading) {
    return (
      <div className="animate-pulse rounded-[26px] border border-slate-200/80 bg-[linear-gradient(180deg,#ffffff_0%,#f8fafc_100%)] p-5 xl:p-6 shadow-[0_24px_55px_-40px_rgba(15,23,42,0.42)]">
        {/* Header com Seletor */}
  ...
  if (!has_market_data || !market_avg_price || !percentage) {
    return (
      <div className="rounded-[26px] border border-slate-200/80 bg-[linear-gradient(180deg,#ffffff_0%,#f8fafc_100%)] p-5 xl:p-6 shadow-[0_24px_55px_-40px_rgba(15,23,42,0.42)]">
        ...
        <div className="rounded-[22px] border border-blue-200 bg-[linear-gradient(135deg,#eff6ff_0%,#ffffff_100%)] p-5 xl:p-6">
          <div className="text-center">
    ...
    <div className="rounded-[26px] border border-slate-200/80 bg-[linear-gradient(180deg,#ffffff_0%,#f8fafc_100%)] p-5 xl:p-6 shadow-[0_24px_55px_-40px_rgba(15,23,42,0.42)]">
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between text-sm">
          ...
          <span className="text-slate-600">{percentage.toFixed(1)}% do mercado</span>
        </div>
        ...
        <div className="relative h-8 w-full overflow-hidden rounded-full border border-slate-200 shadow-inner">
          ...
          >
            <div className="relative">
              {/* Seta */}
              <div className="w-3 h-3 bg-slate-900 rotate-45 mb-1" />
              {/* Linha */}
              <div className="w-0.5 h-6 bg-slate-900 mx-auto" />
            </div>
          </div>
        </div>
      ...
      >
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="rounded-2xl bg-slate-900 px-3 py-2 text-right text-white shadow-sm">
            ...
            <p className="text-base font-black xl:text-lg">{accentValue}</p>
          </div>
        </div>
    ...
    <div className="rounded-[26px] border border-slate-200/80 bg-[linear-gradient(180deg,#ffffff_0%,#f8fafc_100%)] p-5 xl:p-6 shadow-[0_24px_55px_-40px_rgba(15,23,42,0.42)]">
      <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="inline-flex items-center gap-2 rounded-full border border-rose-100 bg-rose-50 px-3 py-1.5 text-[13px] font-semibold text-rose-700 xl:text-sm">
          <Heart className="h-3.5 w-3.5 xl:h-4 xl:w-4" strokeWidth={1.8} />
