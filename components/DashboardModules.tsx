      ...
      {clicksByState.length === 0 ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="relative bg-gradient-to-br from-slate-50 to-blue-50 rounded-lg border border-slate-200 overflow-hidden" style={{ height: '400px' }}>
            ...
            {/* Contador de UFs */}
            <div className="absolute top-3 right-3 bg-green-600 text-white rounded-full w-10 h-10 flex items-center justify-center shadow-lg">
              <div className="text-center">
                <div className="text-lg font-bold">{clicksByState.length}</div>
                <div className="text-[7px] uppercase font-semibold">UFs</div>
              </div>
            </div>
          </div>
        </div>
