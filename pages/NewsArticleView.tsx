  ...
  return (
    <div className="min-h-screen bg-slate-50 py-16">
      <div className="mx-auto max-w-4xl px-4">
        <Link to="/noticias" className="mb-8 inline-flex items-center gap-2 text-sm font-bold text-slate-600 hover:text-green-700">
        ...
        <article className="overflow-hidden rounded-[2rem] border border-slate-100 bg-white shadow-sm">
          ...
          <div className="p-8 md:p-10">
            ...
            {article.agro_impact ? (
              <div className="mt-10 rounded-2xl border border-green-100 bg-green-50 px-6 py-5">
                ...
                <ul className="mt-4 space-y-2 text-sm text-slate-600">
                  {sources.map((source: any, index: number) => (
                    <li key={`${source.source_url}-${index}`}>
                      <a href={source.source_url} target="_blank" rel="noreferrer" className="font-semibold text-green-700 hover:underline">
