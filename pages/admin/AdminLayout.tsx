    ...
    () => [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Convites e captacao', path: '/admin/invites', icon: UserPlus },
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Seguranca', path: '/admin/security', icon: ShieldAlert },
          { label: 'Auditoria', path: '/admin/audit', icon: Shield },
