...
grant execute on function public.admin_list_user_legal_consents(text, text, text, timestamptz, timestamptz, integer, integer) to authenticated;

comment on function public.admin_list_user_legal_consents(text, text, text, timestamptz, timestamptz, integer, integer) is
'Lista consentimentos legais para consulta administrativa com busca, filtros e paginação.';
