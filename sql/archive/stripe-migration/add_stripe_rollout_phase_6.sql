...
-- ==================================================
-- Objetivo:
-- - permitir virada gradual sem migrar toda a base ao mesmo tempo
-- - deixar Stripe para novos clientes enquanto clientes pagos legados seguem no Mercado Pago
-- - manter o criterio centralizado no banco
-- ==================================================
...
comment on column public.payment_settings.stripe_rollout_mode is
  'Controla se a Stripe atende todos os clientes ou apenas clientes sem historico pago';
