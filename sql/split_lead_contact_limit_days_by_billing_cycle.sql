-- ============================================================================
-- BWAGRO - Separar janela de contato do lead por ciclo mensal/anual
-- - Adiciona campos especificos no plano
-- - Mantem compatibilidade com lead_contact_limit_days legado
-- - Recalcula a expiracao dos leads usando o ciclo ativo da assinatura
-- ============================================================================
